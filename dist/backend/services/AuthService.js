...
class AuthService {
    constructor(userRepository, jwtSecret) {
        ...
        this.defaultTokenExpiration = '24h';
        this.rememberMeExpiration = '30d';
    ...
    async register(payload) {
        ...
        const user = await User_1.User.create(payload.username, payload.password);
        // Persist user
     ...
     */
    generateToken(userId, username, expiresIn) {
        const payload = {
            userId,
            username,
        };
